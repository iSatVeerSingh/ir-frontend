...
const ReportItem = () => {
  ...
  //               </Button>
  //             </Flex>
  //             {!report.empty_revised_report_id && (
  //               <Text color={"red"} fontSize={"sm"}>
  //                 Please create a new empty report before making any changes to
  //                 this report item
  //               </Text>
  //             )}
  //             {reportItem.is_revised_in_new && (
  //               <Text color={"green"} mt={2}>
  //                 This item has already revised in new report
  //               </Text>
  //             )}
  //           </Card>
  //         ) : (
  ...
  //           </AlertDialogHeader>
  //           <AlertDialogBody>
  //             After updating the item, this will be revised in new report and
